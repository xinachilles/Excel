...
'http://msdn.microsoft.com/EN-US/library/office/cc861607(v=office.14).aspx'
'http://www.microsoft.com/en-us/download/confirmation.aspx?id=5124'


Public Class ExcelSupport2
    '''<summary> 
    '''Parse and Read SpreadSheet document 
    '''</summary>
    ''' <param name="file_name"> Spread sheet file name</param>
    '''<remarks></remarks>
    Public Sub ReadExcelFile(ByVal file_name As String)

        Dim workbookPart As WorkbookPart
        Dim worksheetPart As WorksheetPart
        Dim sheetData As SheetData
        'Open the document for editing.
        Using spreadsheetDocument As SpreadsheetDocument = spreadsheetDocument.Open(file_name, False)
            ' Code removed here.
            workbookPart = spreadsheetDocument.WorkbookPart
            worksheetPart = workbookPart.WorksheetParts.First
            sheetData = worksheetPart.Worksheet.Elements(Of SheetData)().First()
            Dim text As String
    ...
    End Sub
    Public Sub WriteExcelFile(ByVal file_name As String, ByVal text As String)
        Dim spreadSheet As SpreadsheetDocument = SpreadsheetDocument.Open(file_name, True)
